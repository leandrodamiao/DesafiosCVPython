...
def ftitulo(arg, arg2='-'):
  '''
  -> Função que cria um título centralizado
  :param arg: Texto que será transformado em título
  :param arg2: Caracter das linhas superiores e inferiores (Padrão'-')
